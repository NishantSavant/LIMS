...
urlpatterns = [
    ...
    path('doctor/lab-reports/<int:report_id>/show-to-patient/', doctor_show_report_to_patient, name='doctor_show_report_to_patient'),
    ...
    path('doctor/patient/<str:patient_id>/profile/', doctor_patient_profile, name='doctor_patient_profile'),
    path('doctor/patient/<str:patient_id>/history/', doctor_patient_history, name='doctor_patient_history'),
    path('patient/doctor/<str:doctor_id>/profile/', patient_doctor_profile, name='patient_doctor_profile'),
    path('lab/patient/<str:patient_id>/profile/', lab_patient_profile, name='lab_patient_profile'),
